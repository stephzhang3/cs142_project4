...
class Example extends React.Component {
  ...
  componentDidMount() {
    ...
    this.timerID = window.setInterval(counterIncrFunc, 2 * 1000);
  ...
  handleChange(event) {
    this.setState({ mottoValue: event.target.value });
  }
    ...
    return (
      <div className="container Example">
        ...
        <p>
          ...
          located in the file <code>components/example/Example.jsx</code>. It
        ...
        <p>
          ...
          JavsScript keyword). Although it is possible to interleave JavaScript
        ...
        <p>
          ...
          expression. This feature allows componment&apos;s specification to use
          templated HTML.
        </p>
        <p>
